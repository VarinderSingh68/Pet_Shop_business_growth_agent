...
<title>Something went wrong — Happy Tails Pet Store</title>
...
<body class="bg-paper text-ink font-sans antialiased min-h-screen flex items-center justify-center px-4 relative overflow-hidden">
  ...
  <div class="card-tag relative text-center max-w-md p-10">
    <div class="card-tag__tab">Error</div>
    ...
    <p class="font-display mt-5 text-6xl font-bold text-leash">500</p>
    <h1 class="mt-3 text-2xl font-bold">Something went wrong on our end.</h1>
    <p class="mt-2 text-ink/60">We've logged the error. Please try again in a moment.</p>
