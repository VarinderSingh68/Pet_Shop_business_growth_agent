...
<body class="bg-paper text-ink font-sans antialiased min-h-screen flex items-center justify-center px-4">
  <div class="text-center max-w-md">
    <p class="text-8xl font-bold text-leash">419</p>
    <h1 class="mt-4 text-2xl font-bold">Your session expired.</h1>
    <p class="mt-2 text-ink/60">Go back and try submitting the form again.</p>
